...
1. How would you describe acessibility on the web to someone new to programming?
    a: this is for people who have a handicap that impairs their ability to observe the site. Allowing them the same access as everyone else.
2. Talk about 3 different things you can do to ensure your website is accessible.
    a: alts in images for the blind (site readers), scalable fonts for impaired vision, and closed captioning for hard of heard or deaf
3. How would you explain the concept of a variable to someone new to programming?
    a: a variable is something that you can store anything from ints, strings, arrays, and even objects. It is mainly used to be cross referenced what is stored in it at later time in the code.
4. What is the purpose of using functions in code?
    a: To allow a task to be repeatable as necessary if its necessity arises
